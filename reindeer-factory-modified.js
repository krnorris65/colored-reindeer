...
const coloredReindeerBuilder = function () {
    ...
    const reindeerFactory = name =>
        Object.create(null, {
            "name" : {
                "value" : name, //value of name is the current reindeer in the array
                "enumerable": true},
            "color" : {
    ...
    for (let i = 0; i < reindeer.length; i++) {
        ...
        coloredReindeer.push(reindeerFactory(reindeer[i])); //calls function and inserts it into the array
